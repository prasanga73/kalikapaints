      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-18">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <Link
              to="/admin/dashboard"
              className="ml-2 p-2 text-gray-500 hover:text-kalika-gold transition-colors duration-200"
              title="Admin Portal"
            >
        ...
        >
          <div className="pt-2 space-y-1 border-t border-gray-100">
            ...
            <Link
              to="/admin/dashboard"
              onClick={() => setIsOpen(false)}
              className="block mx-4 mt-2 px-4 py-3 border border-gray-200 text-gray-600 rounded-lg text-sm font-semibold text-center transition hover:bg-gray-50 flex items-center justify-center gap-2"
            >
